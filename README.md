...
Mantle can **fetch styling toolchains on demand at runtime** — Sass, Tailwind, PostCSS plugins — so the UI can adopt new styling tooling **without a full rebuild**. Bounded to *styling* (not arbitrary UI modules or system packages).
